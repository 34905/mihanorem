...
const data = {
    ...
    datasets: [
        {
            label: "hoeveelheid mensen die bepaalde sport spelen",
            data: [5, 6, 6, 8, 4, 5, 8],
            backgroundColor: ['blue', 'black', 'red', 'green', 'yellow', 'pink', 'purple']
        }
    ]
}
        ...
        datasets: [
            {
                label: "Pokemon Types",
                data: [],
                backgroundColor: ['green', '#FFC300', '#ddd', '#5463FF', '2E3840']
            }
        ]
    }
        ...
        const movePowerchart = new Chart(document.getElementById("js--chart--3"), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [movePower],
                    backgroundColor: ['#4f1468', '#FFC300', '#ddd', '#5463FF', '2E3840'],
                    borderColor: ['#4D4D4D']
                }]
            },
            options: {
